...
class PetClassifier(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc1 = nn.Linear(64 * 16 * 16, 128) #first fully connected big layer output vector = 256, linear classifier used
        self.fc2 = nn.Linear(128, 37) #previous 256 output vector and 37 classes
        self.dropout = nn.Dropout(0.7) #dropout to prevent overfitting, 50% chance of dropping neuron in layer
