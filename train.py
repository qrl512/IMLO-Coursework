...
def train():
    ...
    optimiser = torch.optim.SGD(model.parameters(), lr = 0.01, momentum = 0.9) #current values just the same as the Pytorch class definition, need to investigate whether i want momentum or not
